...
login_info = {
    ...
    "user_name": "d0cb8eb409b54ff8444593da78e20495",  # 账号
    "password": "09e373cb61c6dc7d2f9ca59fdc996067",  # 密码
    "aes": 1,
    "auto_login": 0
}
...
light = ['bond_id', 'bond_nm', 'list_dt', 'price', 'premium_rt', 'ytm_rt', 'curr_iss_amt', 'turnover_rt', 'year_left',
         'stock_id', 'stock_nm', 'market_cd']
t = td.strftime('%Y-%m-%d')
